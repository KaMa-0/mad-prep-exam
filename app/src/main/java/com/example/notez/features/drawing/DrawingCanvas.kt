...
package com.example.notez.features.drawing
...
import com.example.notez.core.ui.ColorPickerDialog
import com.example.notez.core.ui.ConfirmationDialog
import com.example.notez.core.ui.DrawingSurface
...
private fun DrawingSurfaceWithTarget(
    ...
    val textureStore = remember { NotezTextureBitmapStore(context) }
