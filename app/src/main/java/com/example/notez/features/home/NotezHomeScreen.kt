...
package com.example.notez.features.home
...
import com.example.notez.AppArgs
...
import com.example.notez.core.navigation.NavigationDestination
import com.example.notez.core.ui.NotezUiState
import com.example.notez.features.home.viewmodel.HomeScreenViewModel
import com.example.notez.features.home.viewmodel.NoteListUiState
...
@Composable
private fun NotezNavigationSuite(
    modifier: Modifier = Modifier,
    ...
    isCompact: Boolean,
    selectedNoteUIState: NotezUiState,
    navigateToCanvas: (Long) -> Unit,
    navigateToDrawingCanvas: (Long) -> Unit,
    navigateUp: () -> Unit
) {
